...
def getDilbertContent(dateofcomic):
  ...
  try:
    ...
    print str(dilbertText[7].get('data-id'))
    print str(dilbertText[7].get('data-description'))
    f.write(str(dilbertText[7].get('data-id')) + " * ")
    f.write(str(dilbertText[7].get('data-description')) + "\n")
